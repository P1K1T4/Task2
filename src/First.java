...
public class First {
    public static void main(String[] args) {
        ...
        System.out.println("2 задание: " + differenceMaxMin(new int[]{10, 4, 1, 4, -10, -50, 32, 21})); // 2
        ...
        System.out.println("8 задание: " + isStrangePair("ratio", "orator")); // 8
    ...
    public static boolean isValid(String index) {
        ...
        for (int i = 0; i < index.length(); i++) {
            ...
            if (askii_char == 32) { // символ пробела
                flag2 = false;
            }
        }
